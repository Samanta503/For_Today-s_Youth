...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-blue-900 via-cyan-800 to-sky-900 shadow-lg sticky top-0 z-50 border-b-4 border-cyan-400 border-opacity-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-12 h-12 bg-gradient-to-br from-cyan-400 via-sky-400 to-blue-500 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-cyan-500/50 group-hover:shadow-2xl transition-all transform group-hover:scale-110">
            <span className="text-white font-bold text-xl">FTY</span>
          </div>
          <span className="font-bold text-2xl bg-gradient-to-r from-cyan-300 via-sky-300 to-blue-300 bg-clip-text text-transparent hidden sm:inline group-hover:from-white group-hover:via-cyan-200 group-hover:to-sky-200 transition-all">
            For Today's Youth
          </span>
        </Link>
          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="text-sm px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-bold rounded-lg shadow-lg hover:shadow-red-500/50 transition-all transform hover:scale-105"
              >
                Logout
              </button>
            </div>
            ...
            <div className="flex gap-3">
              <Link to="/login" className="text-sm px-4 py-2 border-2 border-cyan-300 text-cyan-300 hover:bg-cyan-300 hover:text-blue-900 font-bold rounded-lg transition-all transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/50">
                Login
              </Link>
              <Link to="/signup" className="text-sm px-4 py-2 bg-gradient-to-r from-cyan-400 to-sky-400 hover:from-cyan-300 hover:to-sky-300 text-blue-900 font-bold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
                Sign Up
              </Link>
            </div>
          )}
